...
def group_by_centroid(restaurants, centroids):
    ...
    """
    # BEGIN Question 4
    restaurants_by_centroid = [[find_closest(restaurant_location(r), centroids), r] for r in restaurants]
    return group_by_first(restaurants_by_centroid)
    # END Question 4
...
def best_predictor(user, restaurants, feature_fns):
    ...
    # BEGIN Question 8
    fn_values = [find_predictor(user, reviewed, feature_fn) for feature_fn in feature_fns]

    return max(fn_values, key = lambda x: x[1])[0]
    # END Question 8
