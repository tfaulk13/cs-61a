...
(quote (4 . (5 . (6 . (7 . eight)))))
; expect (4 5 6 7 . eight)

(car (quote (1 2 3 4)))
;expect 1

(begin (define z 7) (+ z 3))
;expect 10
...
(intersect evens (list 8 10 2))
; expect (8 10)

(define (towers-of-hanoi n source dest temp) ; found on StackOverflow
  (if (= n 1)
      (begin
...
; expect towers-of-hanoi

(towers-of-hanoi 3 "source" "dest" "temp")

; expect Move the disk from source to dest
